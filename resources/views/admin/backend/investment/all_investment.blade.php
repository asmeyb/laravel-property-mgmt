    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-end">
            <ol class="breadcrumbs">
                ...
                <li><span>All Investments</span></li>
            </ol>
        </div>
    </header>
    <div class="row">
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">All Investments</h2>
                </header>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (count($property->investments) > 0)
                                                <a href="{{ route('admin_property_details', $property->investments->first()->id) }}" class="btn btn-primary btn-sm">Property Details</a>                                                
                                            @endif
                                        </td>
                                    </tr>
                                @empty
