...
@section('admin')
    ...
    <div class="container-fluid">
        ...
        <div class="mb-4">
            <a href="{{ route('admin_property_details', $investment->id) }}" class="btn btn-outline-primary">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered mb-0">
                        <thead class="table-primary">
                            <tr>
                                <th>Capital Back Type</th>
                                <th>Profit Back After Days</th>
                                <th>Amount</th>
                                <th>Status</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>                            
                                ...
                                <tr>
                                    ...
                                    <td>{{ $investment->property->profit_back ?? 'N/A' }}</td>
                                    <td>${{ $investment->property->per_share_amount ?? 0 }}</td>
                                    <td>
                                        @php
                                            $alreadyCapitalBack = $investment->capitalReturn()->exists();
                                        @endphp
                                        @if (($investment->property->per_share_amount ?? 0) >0  && !$alreadyCapitalBack)
                                            <a href="{{ route('admin.capital.back', $investment->id) }}" class="btn btn-sm btn-primary" onclick="return confirm('Are you sure to return Capital back to this user?')">Capital Back</a>                                        
                                        @else
                                            <span class="btn btn-sm btn-secondary disabled">No Capital Back available</span>
                                        @endif
                                    </td>
                                </tr>
