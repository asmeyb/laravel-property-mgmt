            ...
            <nav id="menu" class="nav-main" role="navigation">
                ...
                <ul class="nav nav-main">
                    ...
                    <li class="nav-parent">
                        ...
                        <ul class="nav nav-children">
                            <li>
                                <a class="nav-link" href="{{ route('pending.profit.withdraw') }}">
                                    Pending Withdraw
                                </a>
                            </li>
                            <li>
                                <a class="nav-link" href="{{ route('approved.profit.withdraw') }}">
                                    Approved Withdraw
                                </a>
                            </li>
                    ...
                    <li class="nav-parent">
                        ...
                        <ul class="nav nav-children">
                            <li>
                                <a class="nav-link" href="{{ route('pending.capital.withdraw') }}">
                                    Pending Capital
                                </a>
                            </li>
                            <li>
                                <a class="nav-link" href="{{ route('approved.capital.withdraw') }}">
                                    Approved Capital 
                                </a>
                            </li>
